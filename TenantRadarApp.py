...
if zip_Capsule is not None:       
    ...
    with st.sidebar:
        ...
        st.download_button('📋 Summary csv Download', df_Sum.to_csv(index=False).encode('utf-8'),file_name='Summary.csv')
        st.download_button('📋 Musubu csv Download', df_MsbGeo.to_csv(index=False).encode('utf-8'),file_name='Musubu.csv')
        st.download_button('📋 Stacking csv Download', df_Stacking.to_csv(index=False).encode('utf-8'),file_name='Stacking.csv')
        st.download_button('📋 Sansan csv Download', df_Sansan.to_csv(index=False).encode('utf-8'),file_name='Sansan.csv')
